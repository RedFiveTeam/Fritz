...
Scenario('should allow you to edit the activity and time of a image and view image in expanded view', (I) => {
  ...
  I.clearField('.slideCard > .card > .row > .col-md-8 > div > .slidesInputs > .timeInputField > input');
  I.fillField('.slideCard > .card > .row > .col-md-8 > div > .slidesInputs > .timeInputField > input', '1234');

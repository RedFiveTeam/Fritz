...
@observer
export class CalloutDropdown extends React.Component<Props> {
  ...
  render() {
    return (
      <div
        className={classNames('calloutDropdownOrUploadStatus', this.props.className)}
      >
        <div className="title">
          <img src={Unicorn}/>
        ...
        <div className="content">
          ...
          }
          {
            ...
            >
              ...
              <span className="uploadComplete">Uploaded to {this.props.slide.calloutTimeForDisplay}</span>
            </div>
          }
          {
...
export const StyledCalloutDropdown = inject(
  'unicornStore',
  'slidesStore',
  'unicornActions',
  'slidesActions'
)(styled(CalloutDropdown)`
  width: 188px;
  height: 168px;
